    ...
    return (
        <div className="
                ...
                <>
                    {!feedbackType ? (
                        ...
                        <FeedbackContentStep
                            ...
                            onFeedbackRestartRequeted={handleRestartFeedback}
            ...
            <footer className="text-xs text-neutral-400">
                Feito com love por <a className="underline underline-offset-2" href="https://github.com/DiegoMotaChrist"> Diego Mota Christ </a>
            </footer>
        </div>
    )
}